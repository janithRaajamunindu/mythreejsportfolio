...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(" coder.janith@gmail.com ");
    setHasCopied(true);
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I’m Janith Tharindu</p>
              <p className="grid-subtext">
                I have honed my skills in both frontend and backend dev,
